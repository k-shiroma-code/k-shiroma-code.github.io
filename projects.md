...
<!-- Tableau Embed -->
<div class="tableauPlaceholder" id="viz1755212456608" style="position: relative">
  <noscript>
    <a href="#">
      <img alt="Dashboard 1" src="https://public.tableau.com/static/images/Cu/Customer_Segmentation_Overview_Github/Dashboard1/1_rss.png" style="border: none" />
    </a>
  </noscript>
  <object class="tableauViz" style="display:none;">
    ...
    <param name="name" value="Customer_Segmentation_Overview_Github/Dashboard1" />
    <param name="tabs" value="no" />
    <param name="toolbar" value="yes" />
    <param name="static_image" value="https://public.tableau.com/static/images/Cu/Customer_Segmentation_Overview_Github/Dashboard1/1.png" />
...
<script type="text/javascript">
  var divElement = document.getElementById('viz1755212456608');
